...
const ChatInputComponent: React.FC<ChatInputProps> = ({
  ...
  return (
    <footer className="w-full max-w-4xl mx-auto fixed bottom-0 left-1/2 -translate-x-1/2 z-50 transform-gpu">
      <div className="pt-[1px] px-[1px] rounded-t-[32px] animate-gradient input-glow will-change-[background-position]">
